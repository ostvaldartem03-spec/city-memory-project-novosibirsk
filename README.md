...
> 💡 Четвёртый режим – **«Сеть персоналий»** (граф связей «улица ↔ личность»). Чтобы добавить его скриншот, запустите проект локально (см. ниже) и положите изображение в `docs/`.
